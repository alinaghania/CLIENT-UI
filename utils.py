    ...
    prompt = ChatPromptTemplate(
        messages=[
            ...
            HumanMessagePromptTemplate.from_template(
                ...
                - Utilise uniquement des hyperlinks uniquement lorsque tu redirige l'utilisateur vers le site de peugeot, ex : cliquez ici pas de liens HTTPS uniquement des hyperliens, mais fait attention à bien rediriger l'utilisateur vers la bonne page, le cliquez ici , doit rediriger vers la page, porte un point de vigilence dessus
